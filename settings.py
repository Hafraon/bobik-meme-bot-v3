...
class Settings:
    ...
    POINTS_FOR_REACTION: int = 5
    POINTS_FOR_SUBMISSION: int = 10
    POINTS_FOR_APPROVAL: int = 20
    POINTS_FOR_TOP_JOKE: int = 50
    ...
    AUTO_APPROVE_THRESHOLD: int = 1000  # Автоматично схвалювати від користувачів з високим рейтингом
    
    # Час для щоденної розсилки
    DAILY_BROADCAST_HOUR: int = 9
    DAILY_BROADCAST_MINUTE: int = 0
    
    # Максимальна довжина тексту анекдоту
    MAX_JOKE_LENGTH: int = 1000
    MAX_MEME_CAPTION_LENGTH: int = 200
    
    # Налаштування дуелей
    DUEL_VOTING_TIME: int = 300  # 5 хвилин для голосування
    MIN_VOTES_FOR_DUEL: int = 3
